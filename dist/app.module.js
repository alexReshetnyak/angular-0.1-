...
var user_list_resolver_service_1 = require("./shared/guards/user-list-resolver.service");
...
var demo_service_1 = require("./shared/services/demo.service");
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        providers: [
            ...
            user_list_resolver_service_1.UserListResolve,
            auth_guard_service_1.AuthGuard,
            can_deactivate_guard_service_1.CanDeactivateGuard,
            { provide: demo_service_1.DemoService, useClass: demo_service_1.DemoService }
        ],
